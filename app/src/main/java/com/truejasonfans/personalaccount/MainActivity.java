package com.truejasonfans.personalaccount;
...
import com.truejasonfans.personalaccount.ui.CaculatorDialogFragment;
import com.truejasonfans.personalaccount.ui.ContentFragment;
import com.truejasonfans.personalaccount.ui.LoginSettingFragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_add:
                CaculatorDialogFragment caculatorDialog = new CaculatorDialogFragment();
                Bundle args = new Bundle();
                args.putInt("num", 2);
                caculatorDialog.setArguments(args);// FragmentActivity将点击的菜单列表标题传递给Fragment
                FragmentManager fragmentManager = getSupportFragmentManager();
//			fragmentManager.beginTransaction()
//					.replace(R.id.content_frame, fragment).commit();
                caculatorDialog.show(getSupportFragmentManager(), "EditNameDialog");
                // 更新选择后的item和title，然后关闭菜单
                mMenuListView.setItemChecked(1, true);
